...
extension Smoothie {
    // Offers an image property for ease of use.
    var image: Image {
        Image("smoothie_\(id)", label: Text(title))
...
extension Smoothie {
    ...
    func matches(_ string: String) -> Bool {
        string.isEmpty || title.localizedCaseInsensitiveContains(string) || menuIngredients.contains {
...
extension Smoothie {
    ...
    static func all(includingPaid: Bool = true) -> [Smoothie] {
        Smoothie(id: "berry-blue", title: String(localized: "Berry Blue", comment: "Smoothie name")) {
            AttributedString(localized: "*Filling* and *refreshing*, this smoothie will fill you up with joy!", comment: "Berry Blue smoothie description")
        ...
        Smoothie(id: "carrot-chops", title: String(localized: "Carrot Chops", comment: "Smoothie name")) {
            AttributedString(localized: "*Packed* with vitamin A and C, Carrot Chops is a great way to start your day!", comment: "Carrot Chops smoothie description")
            Ingredient.orange.measured(with: .cups).scaled(by: 1.5)
        ...
        if includingPaid {
            ...
            Smoothie(id: "hulking-lemonade", title: String(localized: "Hulking Lemonade", comment: "Smoothie name")) {
                AttributedString(localized: "This is not just *any* lemonade. It'll give you *powers* you'll struggle to control!", comment: "Hulking Lemonade smoothie description")
            ...
            Smoothie(id: "kiwi-cutie", title: String(localized: "Kiwi Cutie", comment: "Smoothie name")) {
                AttributedString(localized: "Kiwi Cutie is beautiful *inside* ***and*** *out*! Packed with nutrients to start your day!", comment: "Kiwi Cutie smoothie description")
            ...
            Smoothie(id: "love-you-berry-much", title: String(localized: "Love You Berry Much", comment: "Smoothie name")) {
                AttributedString(localized: "If you *love* berries berry berry much, you will love this one!", comment: "Love You Berry Much smoothie description")
            ...
            Smoothie(id: "one-in-a-melon", title: String(localized: "One in a Melon", comment: "Smoothie name")) {
                AttributedString(localized: "Feel special this summer with the *coolest* drink in our menu!", comment: "One in a Melon smoothie description")
            ...
            Smoothie(id: "peanut-butter-cup", title: String(localized: "Peanut Butter Cup", comment: "Smoothie name")) {
                AttributedString(localized: "Ever wondered what it was like to *drink a peanut butter cup*? Wonder no more!", comment: "Peanut Butter Cup smoothie description")
                Ingredient.almondMilk.measured(with: .cups)
            ...
            Smoothie(id: "thats-a-smore", title: String(localized: "That's a Smore!", comment: "Smoothie name")) {
                AttributedString(localized: "When the world seems to rock like you've had too much choc, that's *a smore*!", comment: "That's a Smore! smoothie description")
                Ingredient.almondMilk.measured(with: .cups)
                Ingredient.coconut.measured(with: .cups).scaled(by: 0.5)
        ...
        if includingPaid {
            Smoothie(id: "tropical-blue", title: String(localized: "Tropical Blue", comment: "Smoothie name")) {
                AttributedString(localized: "A delicious blend of *tropical fruits and blueberries* will have you sambaing around like you never knew you could!", comment: "Tropical Blue smoothie description")
                Ingredient.almondMilk.measured(with: .cups)
                Ingredient.banana.measured(with: .cups).scaled(by: 0.5)
                Ingredient.blueberry.measured(with: .cups).scaled(by: 0.5)
                Ingredient.mango.measured(with: .cups).scaled(by: 0.5)
    ...
    // For Preview_builders i.e., in previews.
    ...
    static var thatIsASmore: Smoothie { Smoothie(for: "thats-a-smore")! }
    ...
    static var thatIsBerryBananas: Smoothie { Smoothie(for: "thats-berry-bananas")! }
}
